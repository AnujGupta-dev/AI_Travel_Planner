...
const Header = () => {
  ...
  <>
    ...
    <div className='select-none flex justify-between xl:w-[40%] gap-5 items-center text-[1.2rem] 2xl:text-[1.5rem] xl:text-[1.5rem] md:text-[1.5rem] text-gray-500 font-bold'>
